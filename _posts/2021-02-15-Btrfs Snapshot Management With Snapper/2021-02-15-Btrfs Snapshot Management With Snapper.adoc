...
:page-layout:
:page-category: Disks
:page-tags: [btrbk, btrfs, elementaryos, linux, snapper, snapshots, timeshift, ubuntu]
...
+
--
There are two important distinctions from the root fileystem configuration.
...
This post has given a walkthrough of managing Btrfs snapshots with Snapper.
