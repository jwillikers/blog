...
:page-layout:
:page-category: Disks
:page-tags: [backups, Btrfs, Cryptsetup, elementary, encryption, fstab, Linux, systemd, udisks2, Ubuntu]
...
Instructions for unlocking, mounting, unmounting, and locking the filesystem are provided for both Cryptsetup and {udisks2}.
...
[source,sh]
----
➜ sudo mkfs -t btrfs -L Private /dev/dm-1
btrfs-progs v4.15.1
...
Mounted /dev/dm-1 at /run/media/jordan/Private
----
