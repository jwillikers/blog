...
[source,sh]
----
➜ udisksctl mount -b /dev/disk/by-label/ventoy --no-user-interaction
...
[source,sh]
----
➜ udisksctl unmount -b /dev/disk/by-label/ventoy --no-user-interaction
Unmounted /dev/sdb1.
----
...
[source,sh]
----
➜ udisksctl unmount -b /dev/disk/by-label/VTOYEFI --no-user-interaction
Unmounted /dev/sdb2.
----
...
Update Ventoy  1.0.29 ===> 1.0.30   Continue? (y/n)y
