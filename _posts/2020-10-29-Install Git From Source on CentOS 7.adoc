...
. Update the `MANPATH` environment variable to be able to read the man pages.
+
--
User::
_fish_:::
...
----
➜ mkdir -p ~/.config/fish/conf.d; and \
  echo 'set -gx MANPATH ~/.local/(gcc -dumpmachine)/share/man:' >> \
    ~/.config/fish/conf.d/machine_paths.fish
➜ exec fish
----
...
[source,sh]
----
➜ echo 'export MANPATH=$HOME/.local/$(gcc -dumpmachine)/share/man:' >> ~/.bashrc
➜ source ~/.bashrc
----
...
[source,sh]
----
➜ set -Ux MANPATH /usr/local/share/man:
----

_Bash_:::
[source,sh]
----
➜ echo "export MANPATH=/usr/local/share/man:" >> ~/.bashrc
➜ source ~/.bashrc
----
--

. Update the `INFOPATH` environment variable as well.
+
--
User::
_fish_:::
...
----
➜ mkdir -p ~/.config/fish/conf.d; and \
  echo 'set -gpx INFOPATH ~/.local/(gcc -dumpmachine)/share/info' >> \
    ~/.config/fish/conf.d/machine_paths.fish
➜ exec fish
----
...
[source,sh]
----
➜ echo 'export INFOPATH=$HOME/.local/$(gcc -dumpmachine)/share/info:$INFOPATH' >> ~/.bashrc
➜ source ~/.bashrc
----
...
[source,sh]
----
➜ set -pUx INFOPATH /usr/local/share/info
----
