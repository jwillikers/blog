...
Download the https://www.geoghegan.ca/scripts/unbound-adblock.sh[unbound-adblock.sh script] to `/usr/local/bin`.
...
Set the appropriate permissions on the script, making it owned by the _root_ user and the _bin_ group.
